...
export default function Template({title,desc1,desc2,image,type,setIsLoggedIn}) {
  console.log(title,desc1,desc2)
  return (
    <div className="flex w-11/12 max-w-[1160px] py-12 mx-auto gap-y-0 gap-x-12 justify-between">
      <div className="w-11/12 max-w-[450px] mx-0 text-white">
        ...
        {
            type == "signup" ? <SignUpForm setIsLoggedIn={setIsLoggedIn}></SignUpForm>:<LoginForm setIsLoggedIn={setIsLoggedIn}></LoginForm>
        }
